...
import (
	...
	latencyadmission "sigs.k8s.io/gateway-api-inference-extension/pkg/epp/framework/plugins/scheduling/scorer/predictedlatency/admission"
	latencypicker "sigs.k8s.io/gateway-api-inference-extension/pkg/epp/framework/plugins/scheduling/scorer/predictedlatency/picker"
	latencypredictor "sigs.k8s.io/gateway-api-inference-extension/pkg/epp/framework/plugins/scheduling/scorer/predictedlatency/predictor"
	latencyscorer "sigs.k8s.io/gateway-api-inference-extension/pkg/epp/framework/plugins/scheduling/scorer/predictedlatency/scorer"
...
func (r *Runner) registerInTreePlugins() {
	...
	fwkplugin.Register(latencypicker.AffinityWeightedPickerType, latencypicker.AffinityWeightedPickerFactory)
