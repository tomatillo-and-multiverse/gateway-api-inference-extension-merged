...
func TestPredictedLatency_TypedName(t *testing.T) {
	...
	tn := router.TypedName()
	assert.Equal(t, "latency-predictor", tn.Type, "Type should be latency-predictor")
	assert.Equal(t, "latency-predictor", tn.Name, "Default name should be latency-predictor")
}
...
func TestPredictedLatency_WithName(t *testing.T) {
	...
	tn := router.TypedName()
	assert.Equal(t, "latency-predictor", tn.Type, "Type should remain latency-predictor")
